...
with tab1:
    ...
    sample_texts = {
        ...
        "Clinical Report Sample": (
            "The patient was admitd to medical ward for chest pain and shortness of brath. He has had intermittet painn form september 2025, which worsens with exertion or stress. Pain dull and radiates to left arm. On exam, nasal mucos was erythematus. PMH: hypertension and type 2 diabetes. Patient admits poor med compliance due 2 financial issues."
        ),
